package com.stpl.itemmaster;

import com.stpl.itemmaster.config.ApplicationProperties;
import com.stpl.itemmaster.config.DefaultProfileUtil;
...
public class SampleappApp {
    ...
    public SampleappApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes sampleapp.
     * <p>
